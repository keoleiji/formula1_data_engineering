...
mount_adls("formula1dlbrazil", "raw-bronze")

# COMMAND ----------

mount_adls("formula1dlbrazil", "processed-silver")
mount_adls("formula1dlbrazil", "presentation-gold")

# COMMAND ----------

mount_adls("formula1dlbrazil", "demo")

# COMMAND ----------

dbutils.fs.ls("/mnt/formula1dlbrazil/demo")